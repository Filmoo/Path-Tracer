...
{   
    ...
    Plane *left = new Plane(new Uniform_Texture(Color(0,0,0.7), 0.9, 0.5, 32, 0, 0), Point3(0,5,0), Vector3(0,-1,0));
    scene->addObject(left);
    Plane *right = new Plane(new Uniform_Texture(Color(0.7,0,0), 0.9, 0.5, 32, 0, 0), Point3(0,-5,0), Vector3(0,1,0));
    scene->addObject(right);
    Plane *top = new Plane(new Uniform_Texture(Color(0.2,0.2,0.2), 0.9, 0.5, 32, 0, 0), Point3(5,0,5), Vector3(0,0,-1));
    scene->addObject(top);
    Plane *behind = new Plane(new Uniform_Texture(Color(0, 0, 0.7), 0.9, 0.5, 32, 0, 0), Point3(-5, 0, 0), Vector3(-1,0,0));
    scene->addObject(behind);   
    
    Sphere *glassSphere = new Sphere(new Dieletric_Texture(1.7), Point3(10, 1.5, 2.5), 1);
    scene->addObject(glassSphere); 
    Sphere *glassSphere2 = new Sphere(new Dieletric_Texture(2.5), Point3(8, -3, 1), 1);
    //scene->addObject(glassSphere2);   
    
    Sphere *normalSphere1 = new Sphere(new Uniform_Texture(Color(0.6,0.9,0.6), 0.5, 0.5, 32, 0, 0), Point3(10, -1.5, 1), 1);
    scene->addObject(normalSphere1);
    Sphere *normalSphere2 = new Sphere(new Uniform_Texture(Color(0.9,0.7,0.8), 0.9, 1, 32, 0, 0), Point3(10, 2, 1), 1);
    //scene->addObject(normalSphere2);

    
    Sphere *metalSphere1 = new Sphere(new Metal_Texture(Color(0.5,0.5,0.5), 3), Point3(10, 2, 1), 1);
    scene->addObject(metalSphere1);

    Sphere_Light *lightSphere = new Sphere_Light(Color(1,1,1), Point3(10, 0, 104.7), 100, 0.8);
    ...
    std::cout << "Nomber of objects in the scene: " << scene->objects.size() << std::endl;
